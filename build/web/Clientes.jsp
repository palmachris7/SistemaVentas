                            ...
                            <tbody> 
                                <c:forEach var="em" items="${clientes}">
                                    <tr>
                                        ...
                                        <td>${em.getEs()}</td>                                        
                                        <td>
                                            <a class="btn btn-outline-primary"  href="Controlador?menu=Cliente&accion=Editar&id=${em.getId()}"><i class='bx bx-edit-alt'></i></a>
                                            <a class="btn btn-outline-danger" href="Controlador?menu=Cliente&accion=Delete&id=${em.getId()}"><i class='bx bx-trash'></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
